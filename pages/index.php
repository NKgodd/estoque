                ...
                <tbody>
                    <?php foreach ($produtos as $produto): ?>
                        <tr>
                            ...
                            <td>
                                <!-- Modificação para que o nome do produto seja um link para o relatório -->
                                <a href="../pages/relatorios.php?id=<?php echo $id; ?>" title="Ver relatório deste produto">
                            ...
                            <td class="container-modficadores">
                                <a href="editar.php?id=<?php echo $produto['id']; ?>" title="Editar este produto">Editar</a>
                                <a href="excluir.php?id=<?php echo $produto['id']; ?>" title="Excluir este produto do estoque">Excluir</a>
